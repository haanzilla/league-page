/*   STEP 1   */
export const leagueID = "731686009804308480"; // your league ID
...
export const homepageText = `
  <p>A decade in the making, The DTF Club remains the premiere fantasy football league that all wish they were members of. #JusticeForLamport </p>
`;
...
export const managers = [
    {
      ...
      "rival": {
        name: "Aidan", // Can be anything (usually your rival's name)
